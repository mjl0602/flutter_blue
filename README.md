...
Since the original flutter_blue is no longer maintained, I forked the original repository and continued to maintain it for newer versions of Flutter:
...
由于原先的flutter_blue不再维护，我fork了原仓库并针对新版本flutter继续维护：
